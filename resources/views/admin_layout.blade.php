...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link rel="stylesheet" href="{{ URL::asset('back-end/css/morris.css') }}" type="text/css" />
    <!-- calendar -->
    <link rel="stylesheet" href="{{ URL::asset('back-end/css/monthly.css') }}">
    <!-- //calendar -->
    <!-- //font-awesome icons -->
    <script src="{{ URL::asset('back-end/js/jquery2.0.3.min.js') }}"></script>
    <script src="{{ URL::asset('back-end/js/raphael-min.js') }}"></script>
    <script src="{{ URL::asset('back-end/js/morris.js') }}"></script>
</head>
...
<body>
        ...
        <header class="header fixed-top clearfix">
            ...
            <div class="top-nav clearfix">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="{{ URL::asset('back-end/images/2.png') }}">
                            <span class="username">
                                <?php
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('/categories') }}">List Category</a></li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('/brands') }}">List Brand</a></li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('/products') }}">List Product</a></li>
    ...
    <script src="{{ URL::asset('back-end/js/jquery.nicescroll.js') }}"></script>
    ...
    <!-- calendar -->
    <script type="text/javascript" src="{{ URL::asset('back-end/js/monthly.js') }}"></script>
