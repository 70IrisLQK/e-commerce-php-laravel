                        ...
                        <tr>
                            ...
                            <td><span class="text-ellipsis">
                                    ...
                                    @else($product->status == 1)
                                        <a href="{{ url('inactive-product', $product->id) }}">
                                            <span class="fa-thumb-styling fa fa-thumbs-up"></span>
                                        </a>
                                    @endif
                                </span></td>
                            <td>
                                <a href="{{ url('update-product', $product->id) }}" class="active styling-edit"
                                    ui-toggle-class="">
                                    <i class="fa fa-pencil-square-o text-sucess text-active"></i>
                                </a>
                                <a href="{{ url('delete-product', $product->id) }}" class="active styling-edit"
